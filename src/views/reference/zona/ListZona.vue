...
import zonaData from "@/utils/Api/reference/zonaData";
...
const filteredItems = (search) => {
  ...
  const filteredR = sortedData.value.filter((item) => {
    (item.tlk.toLowerCase().indexOf(search.toLowerCase()) > -1) |
  ...
  <div class="flex flex-col basis-full grow-0 shrink-0 w-full this">
    ...
    <div class="flex w-screen mt-[115px]">
      ...
      <div
        ...
        :class="[zonaData.length < 10 ? 'h-screen' : 'h-full']"
      >
            ...
            <div class="py-2 flex md:mx-0">
              <label class="relative block">
                ...
                <input
                  ...
                  placeholder="Search bt TLK / Company"
                  type="text"
                  name="search"
                  v-model="search"
