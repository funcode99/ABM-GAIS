...
import reimbursementdata from "@/utils/Api/reference/reimbursementdata";
...
const tableHead = [
  { Id: 1, title: "No" },
  { Id: 2, title: "Reimbursement Type" },
  { Id: 3, title: "Parent Type" },
  { Id: 4, title: "Company" },
  { Id: 5, title: "Actions" },
];
</script>
  ...
  <div class="flex flex-col basis-full grow-0 shrink-0 w-full this">
    ...
    <div class="flex w-screen mt-[115px]">
      ...
      <div
        ...
        :class="[reimbursementdata.length < 10 ? 'h-screen' : 'h-full']"
      >
              ...
              >
                ...
                <tbody class="bg-[#F5F5F5]">
                  <tr
                    ...
                    v-for="(data, index) in reimbursementdata"
                    :key="index"
                  >
                    <td class="relative">
