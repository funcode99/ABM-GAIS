...
import ModalAdd from "@/components/reference/car/ModalAdd.vue";
import ModalEdit from "@/components/reference/car/ModalEdit.vue";
...
const tableHead = [
  ...
  { Id: 2, title: "Car", jsonData: "plat_number" },
...
const filteredItems = (search) => {
  ...
  const filteredR = sortedData.value.filter((item) => {
    (item.plat_number.toLowerCase().indexOf(search.toLowerCase()) > -1) |
            ...
            <div class="py-2 flex md:mx-0">
              <label class="relative block">
                ...
                <input
                  ...
                  placeholder="Search by Car / Company"
                  type="text"
                  name="search"
                  v-model="search"
