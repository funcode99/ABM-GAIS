...
const tableHead = [
  ...
  { Id: 2, title: "Created Date", jsonData: "no_booking_meeting" },
  { Id: 3, title: "Booking No", jsonData: "no_booking_meeting" },
  { Id: 4, title: "Requestor", jsonData: "employee_name" },
  { Id: 5, title: "Room", jsonData: "title" },
  { Id: 6, title: "Booking Time", jsonData: "available_status" },
    ...
    <div class="flex w-screen content mt-[115px]">
      ...
      >
        <div class="bg-white w-full rounded-t-xl pb-3 relative custom-card">
          ...
          >
            <p
              class="font-JakartaSans text-base capitalize text-[#0A0A0A] font-semibold py-3"
            >
              Approval Meeting Room
            </p>
          </div>
                  ...
                  >
                    ...
                    <td v-if="id_role != 'ADMTR'">
                      <div class="flex justify-center items-center gap-2">
                        <router-link :to="`/approval-meeting-room/${data.id}`">
                          <button>
                            <img
                              :src="icon_ceklis"
                              class="w-6 h-6"
