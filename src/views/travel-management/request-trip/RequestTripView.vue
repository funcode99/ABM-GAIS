<script setup>
  ...
  import ModalReschedule from '@/components/request-trip/reschedule/index.vue'
            ...
            <form class="flex-1" @submit.prevent="">
              ...
              <detailsFormHeader v-if="!isAdding & headerTitle !== 'Cash Advance' " :title="headerTitle"
                ...
                <div class="flex gap-2 " :class="viewLayout === 'document' ? 'visible' : 'invisible'">
                  ...
                  <!-- Reschedule Button -->
                  <ModalReschedule v-if="headerTitle === 'Airlines' && purposeOfTripData[currentIndex].status === 'Waiting Approval' || purposeOfTripData[currentIndex].status === 'Confirmed'"></ModalReschedule>
