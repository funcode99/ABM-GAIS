<script setup>
    ...
    const fetch = async () => {
        ...
        sortedDataFieldBreak.value = sortedData.value.filter((item) => {
          return item.code_document == 'FB'
        })
        sortedDataTaxiVoucher.value = sortedData.value.filter((item) => {
          return item.code_document == 'TV'
        })
  ...
  <div class="flex flex-col w-full this h-[100vh]">
    ...
    <div class="flex w-screen content mt-[115px]">
      ...
      <tableContainer>
            ...
            <div class="block overflow-x-auto">
              ...
              >
                ...
                <tbody>
                  <tr
                    class="font-JakartaSans font-normal text-sm"
                    v-for="(data, index) in sortedDataFieldBreak"
                    :key="data.id"
                  >
                    <td>
                      <input type="checkbox" name="checks" />
        ...
        <!-- TABLE Field Break -->
        <div v-if="requestTripType === 'Taxi Voucher'">
            ...
            <div class="block overflow-x-auto">
              ...
              >
                ...
                <tbody>
                  <tr
                    class="font-JakartaSans font-normal text-sm"
                    v-for="(data, index) in sortedDataTaxiVoucher"
                    :key="data.id"
                  >
                    <td>
                      <input type="checkbox" name="checks" />
