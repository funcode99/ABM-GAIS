...
const tableHead = [
  ...
  { Id: 5, title: "CA", jsonData: "no_ca" },
  { Id: 6, title: "Total", jsonData: "total_ca" },
...
const exportToExcel = () => {
  ...
  sortedData.value.forEach((data, rowIndex) => {
    ...
    worksheet.getCell(rowIndex + 2, 5).value = data.no_ca;
    worksheet.getCell(rowIndex + 2, 6).value = data.total_ca;
  ...
  workbook.xlsx.writeBuffer().then((buffer) => {
    ...
    a.href = url;
    a.download = "settlement_data.xlsx";
    a.click();
              ...
              >
                ...
                <td class="flex flex-wrap gap-4 justify-center h-full">
                  <router-link
                    ...
                    v-if="data.status == 'Draft' || data.status == 'Revision'"
                  >
                    <button>
