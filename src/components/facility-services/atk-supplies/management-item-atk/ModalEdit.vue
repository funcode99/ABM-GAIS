  ...
  <div class="modal">
    <div class="modal-dialog bg-white w-3/5">
      <nav class="sticky top-0 z-50 bg-[#015289]">
        ...
        <p
          class="font-JakartaSans font-semibold text-white mx-4 py-2 text-start"
        >
          Edit Item
        </p>
      </nav>
      ...
      <main class="modal-box-inner-brand pb-14">
        ...
        <div class="flex justify-start px-6 items-center gap-2">
          ...
          {{ idItems }}
            <input
              class="basis-10/12 appearance-none border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
              v-model="idItems"
              placeholder="ID Item"
