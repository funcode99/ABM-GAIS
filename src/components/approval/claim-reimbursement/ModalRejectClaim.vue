...
<template>
  ...
  <input type="checkbox" id="my-modal-reject-claim" class="modal-toggle" />
  <div class="modal">
    <div class="modal-box relative">
      ...
      <main class="modal-box-inner-reject-claim-reimbursement">
        <form class="pt-4">
...
.modal-box-inner-reject-claim-reimbursement {
  --tw-scale-x: 0.9;
  --tw-scale-y: 0.9;
