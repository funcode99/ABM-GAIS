...
<template>
  <label for="my-modal-reject-shortcut-atk" class="cursor-pointer">
    <img :src="iconClose" class="w-5 h-5 mt-[2px]" />
  </label>

  <input
    type="checkbox"
    id="my-modal-reject-shortcut-atk"
    class="modal-toggle"
  />
  <div class="modal">
    <div class="modal-box relative">
      <nav class="sticky top-0 z-50 bg-[#015289]">
        <label
          for="my-modal-reject-shortcut-atk"
      ...
      <main class="modal-box-inner-reject-shortcut-atk">
        <form class="pt-4">
...
.modal-box-inner-reject-shortcut-atk {
  --tw-scale-x: 0.9;
  --tw-scale-y: 0.9;
