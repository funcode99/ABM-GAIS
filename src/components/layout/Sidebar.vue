...
<template>
  ...
  <div class="relative">
    ...
    >
      ...
      <div class="absolute top-10 right-[-16px] w-[32px] h-[32px] bg-blue rounded-full sm:flex justify-center items-center hidden cursor-pointer" @click="sidebar.changeWide">
