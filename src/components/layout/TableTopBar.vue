    ...
    <div class="bg-white rounded-t-xl pb-3 relative custom-card">
      ...
      <div class="flex flex-wrap items-center px-4 py-2 gap-y-2">
          ...
          <div class="flex items-center gap-4">
            ...
            <select class="font-JakartaSans bg-white w-full lg:w-40 border border-slate-300 rounded-md py-2 px-2 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm cursor-pointer">
          ...
          :class="[$route.path == '/user' ? 'inline' : 'hidden',]">
            ...
            <select class="font-JakartaSans bg-white w-full lg:w-40 border border-slate-300 rounded-md py-2 px-2 shadow-sm focus:tline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm cursor-pointer">
      ...
      <div class="flex items-center gap-1 pt-6 pb-4 px-4 h-4">
        ...
        <select class="font-JakartaSans bg-white w-full lg:w-16 border border-slate-300 rounded-md py-1 px-2 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm cursor-pointer" v-model="pageMultiplier" @change="$emit('changeShowing', pageMultiplierReactive)">
          <option>10</option>
          <option>25</option>
          <option>50</option>
          <option>75</option>
